...
- Item 3 is resolved by the PR carrying this status update: Main-requested context compaction is drained at awaited post-turn runtime-event boundaries rather than by a competing background session-lock task.
