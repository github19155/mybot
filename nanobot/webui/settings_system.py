    ...
    return {
        "runtime": {
            ...
            "dream": {
                ...
                "mode": "adaptive",
                "poll_interval_seconds": defaults.dream.poll_interval_seconds,
                "cooldown_minutes": defaults.dream.cooldown_minutes,
                "idle_minutes": defaults.dream.idle_minutes,
                "pressure_entries": defaults.dream.pressure_entries,
                "max_defer_minutes": defaults.dream.max_defer_minutes,
                "max_entries_per_run": defaults.dream.max_entries_per_run,
                "max_runs_per_day": defaults.dream.max_runs_per_day,
                "retention_days": defaults.dream.retention_days,
            },
