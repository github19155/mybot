...
- Item 4 is resolved: configured provider+model routes are independent offerings with persistent passive telemetry and physical-request admission, while the existing Subagent admission layer remains the Agent-level scheduler.
